...
public class ItemController {
	...
	public void adminDeleteItem() {
		adminPrintItemList();
		System.out.println("삭제할 아이템 번호 입력 : ");
		int num = Util.scan.nextInt();
		if (itemDAO.adminDeleteItem(num) == 0) {
			System.out.println("없는 번호 입니다.");
		} else {
			System.out.println("선택한 아이템이 삭제 되었습니다.");
		}
	...
	public void menuItemList(String category) { // 쇼핑 아이템추가 부분
